...
class SimpleMapTest {
    ...
    @Test
    void whenGetFirstInput() {
        assertThat(map.put(2, "3")).isFalse();
        assertThat(map).hasSize(4);
    ...
    @Test
    void whenPutNullIsTrue() {
        SimpleMap<Integer, String> map = new SimpleMap<>();
        assertThat(map.put(null, null)).isTrue();
    }

    @Test
    void whenPutNullThenNullIsFalse() {
        SimpleMap<Integer, String> map = new SimpleMap<>();
        assertThat(map.put(null, null)).isTrue();
